...
public class TowersDefinitions {
	...
	def shock(){
		...
		utils.custom.genericprovider.provide{ position ->
			...
			color:utils.color(1.0f, 1.0f, 1.0f, 1.0f),
			levels:[
			[level:1, maxTargets: 1, radius:50f, fireDuration:500, reloadTime:1500, shockFactor:0.5f/500, upgradeCost:7, sellCost:5],
			[level:2, radius:55f, shockFactor:0.6f/500, upgradeCost:15, sellCost:5],
			[level:3, maxTargets: 2, radius:60f, fireDuration:500, reloadTime:1400, shockFactor:0.6f/500, upgradeCost:22, sellCost:5],
			[level:4, radius:65f, shockFactor:0.7f/500, upgradeCost:30, sellCost:5],
			[level:5, maxTargets: 3,radius:70f, fireDuration:500, reloadTime:1300, shockFactor:0.75f/500, upgradeCost:37, sellCost:5],
			[level:6, radius:75f, shockFactor:0.85f/500, upgradeCost:45, sellCost:5],
			[level:7, maxTargets: 4,radius:100f, fireDuration:500, reloadTime:1200, shockFactor:0.9f/500, sellCost:85]]					
			]
		})
